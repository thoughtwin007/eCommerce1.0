...
const router = Router();
router.route('/').get(authUser.islogedin, authUser.isAuthorized('user'), cartController.getCart)
router.route('/').post(authUser.islogedin, authUser.isAuthorized('user'), cartController.addToCart)
